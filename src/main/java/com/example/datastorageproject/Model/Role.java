...
public enum Role {
    ADMIN(Set.of(Permission.ADMIN_PERMISSION_WRITE, Permission.ADMIN_PERMISSION_READ, Permission.EMPLOYEE_PERMISSION_WRITE, Permission.CUSTOMER_PERMISSION_READ)),
